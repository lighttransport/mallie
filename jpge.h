...
// If return value is true, buf_size will be set to the size of the compressed
// data.
...
// output stream.
// put_buf() is generally called with len==JPGE_OUT_BUF_SIZE bytes, but for
// headers it'll be called with smaller amounts.
class output_stream {
public:
